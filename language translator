- 👋 Hi, I’m @Neeshu13
- 👀 I’m interested in developing in coding skill.
- 🌱 I’m currently learning python and unittest.

<!---
Neeshu13/Neeshu13 is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
label2=Label(root,text='Translate:',font=('times',15,'italic bold'),bg='turquoise1')
...
#imgbt2=PhotoImage(file='enter.png')
